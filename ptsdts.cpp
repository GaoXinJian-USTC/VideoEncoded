...
int main(int argc, char *argv[])
{
    ...
    const char *in_filename_v = "D:\\projects\\audio_encode\\ba.h265";
...
//            break;
    ...
    while (1) {
                ...
                do{
                    ...
                    if(pkt.stream_index==videoindex_v){
                        ...
                        if(pkt.pts==AV_NOPTS_VALUE){
                            ...
                            int64_t calc_duration=(double)AV_TIME_BASE/av_q2d(in_stream->r_frame_rate); //相邻两帧的持续时间单位
                            //Parameters
        ...
        int64_t dts_time = av_rescale_q(pkt.dts, ofmt_ctx->streams[0]->time_base, {1,AV_TIME_BASE});
